...
$ docker commit -a="glfadd" -m="python env" centos7 centos7:v0.2
...
```
执行命令报错
warning: setlocale: LC_CTYPE: cannot change locale (zh_CN.UTF-8): No such file or directory version-file   Detect the file that sets the current pyenv version
