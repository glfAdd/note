...
[虚拟号码平台](https://sms-activate.org/cn)

```
kingstonadd@gmail.com
FD132ksdk(*)(*)
```
...
```
从软件上 V2Ray 不区分服务器版和客户端版，服务器和客户端运行的 V2Ray 是同一个软件
```

##### 时间校准

V2Ray 的验证方式包含时间, 如果时间不正确，也无法连接 V2Ray 服务器的，服务器会认为你这是不合法的请求
...
[价格对比](https://justmysockser.com/21.html)

[如何退款](https://v2xtls.org/just-my-socks-%e6%80%8e%e4%b9%88%e9%80%80%e6%ac%be/)

[购买教程](https://www.bwgss.org/510.html)

```
官网备用 3：https://justmysocks3.net/（中国大陆可以访问）
官网备用 4：https://justmysocks5.net/（中国大陆可以访问）

https://justmysocks3.net/members/cart.php?gid=1
https://justmysocks5.net/members/cart.php?gid=1 


Just My Socks 优惠码: JMS9272283
Just My Socks官方消息：国庆期间，cfb加密封禁比较严重。所以Just My Socks暂停支持cfb加密。
```

##### 客户端 - Mac - clashX

[配置教程](https://v2xtls.org/clashx%e9%85%8d%e7%bd%aejust-my-socks%e6%95%99%e7%a8%8b/) (可用)

[配置文件模板下载地址](https://v2xtls.org/clash_jms2.yaml)
