...
$("a."+opt.wrapperClass).click(function(e){e.preventDefault();var lightbox,lbImageHref=$(this).attr("href");if($("#lightbox").length){$("#lightbox-img").html("<img src='"+lbImageHref+"' />");$("#lightbox").show();}else{lightbox="<div id='lightbox'>"+"<p>点此关闭</p>"+"<div id='lightbox-img'>"+"<img src='"+lbImageHref+"' />"+"</div>"+"</div>";$("body").append(lightbox);}});$(document).on("click","#lightbox",function(){$(this).hide();});});};$.fn.h5lightbox.defaults={target:"data-large-src",wrapperClass:"lightbox"};})(jQuery);
